...
const PROVIDER_META: Record<string, ProviderMeta> = {
  ...
  minimax: { kind: 'model', setup: 'api-key', shortDescription: 'MiniMax text and multimodal models (OpenAI SDK).' },
  'minimax-anthropic': { kind: 'model', setup: 'api-key', shortDescription: 'MiniMax models via Anthropic SDK — supports thinking/reasoning.' },
