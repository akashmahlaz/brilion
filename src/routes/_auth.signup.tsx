...
import { signInWithGoogle, signInWithLinkedIn, signUpWithEmail } from '#/lib/auth-client'
...
function SignupPage() {
  ...
  async function handleGoogleLogin() {
    console.log('[signup] handleGoogleLogin')
  ...
  async function handleLinkedInLogin() {
    console.log('[signup] handleLinkedInLogin')
    setSocialLoading('linkedin')
    try {
      await signInWithLinkedIn('/')
    } catch (err) {
      console.error('[signup] LinkedIn login error:', err)
      setSocialLoading(null)
    }
  }
  ...
  async function handleSignup(e: React.FormEvent) {
    e.preventDefault()
    console.log('[signup] handleSignup for:', email)
    setError('')
    ...
    try {
      ...
      console.log('[signup] signUpWithEmail result:', result)
      if (result.error) {
