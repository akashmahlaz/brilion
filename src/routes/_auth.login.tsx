...
import { signInWithGoogle, signInWithLinkedIn, signInWithEmail } from '#/lib/auth-client'
...
function LoginPage() {
  ...
  async function handleLinkedInLogin() {
    console.log('[login] handleLinkedInLogin')
    setSocialLoading('linkedin')
    try {
      await signInWithLinkedIn('/')
    } catch (err) {
      console.error('[login] LinkedIn login error:', err)
      setSocialLoading(null)
    }
  }
  ...
  async function handleEmailLogin(e: React.FormEvent) {
    e.preventDefault()
    console.log('[login] handleEmailLogin for:', email)
    setError('')
    setLoading(true)
    try {
