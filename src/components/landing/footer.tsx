  ...
  return (
    <footer className="border-t border-gray-200/60 bg-white">
      <div className="max-w-6xl mx-auto px-6 pt-16 pb-10">
        ...
        <div className="grid grid-cols-2 gap-10 md:grid-cols-6 lg:gap-12">
          ...
          <div className="col-span-2">
            ...
            <p className="mt-4 text-sm text-gray-400 leading-relaxed max-w-xs">
              One platform to automate your entire digital life. Connect your
              apps. Send a message. Watch it happen.
            </p>
            ...
            <div className="mt-6 flex items-center gap-3">
              {[
                ...
                <a
                  ...
                  className="flex size-9 items-center justify-center rounded-full border border-gray-200/60 text-gray-400 hover:text-gray-600 hover:border-gray-300 transition-all"
                >
        ...
        {/* Bottom bar */}
        <div className="mt-14 flex flex-col items-center gap-4 border-t border-gray-100 pt-8 sm:flex-row sm:justify-between">
          <p className="text-xs text-gray-400">
            &copy; {new Date().getFullYear()} Brilion Technologies. All rights reserved.
          </p>
