...
const FOOTER_LINKS = {
  ...
  Solutions: [
    { label: 'Marketing Teams', href: '/social' },
    { label: 'Developers', href: '/coding' },
    { label: 'Traders', href: '/trading' },
    { label: 'Agencies', href: '/#how-it-works' },
    { label: 'Freelancers', href: '/#how-it-works' },
  ],
  Resources: [
    { label: 'Documentation', href: '/docs' },
    { label: 'API Reference', href: '/mcp' },
      ...
      <div className="max-w-6xl mx-auto px-6 pt-16 pb-10">
        ...
        <div className="mt-14 flex flex-col items-center gap-4 border-t border-gray-200/40 pt-8 sm:flex-row sm:justify-between">
          ...
          <div className="flex items-center gap-6">
            <Link to="/privacy" className="text-[12px] text-gray-400 hover:text-gray-600 transition-colors">
              Privacy Policy
            </Link>
            <Link to="/terms" className="text-[12px] text-gray-400 hover:text-gray-600 transition-colors">
              Terms of Service
            </Link>
            <Link to="/support" className="text-[12px] text-gray-400 hover:text-gray-600 transition-colors">
              Cookies
            </Link>
          </div>
        </div>
